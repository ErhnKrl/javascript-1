...
try {
  ...
  function passTheAssertions1() {
    ...
    let a2=[]; // declare and assign a2
    a1=a2;
    console.assert(a1 === a2, 'a1 should strictly equal a2');

    b1=[1,2]; // declare and assign b1
    b2=[1,2]; // declare and assign b2
    ...
    console.assert(a1[0] === 'hi!', 'a1.[0] should strictly equal "hi!"');

    b2=["bye!"]; // write two lines to pass the assertions
    b1=b2;
    console.assert(b1[0] === b2[0], 'b1[0] should strictly equal b2[0]');
    console.assert(b1[0] === 'bye!', 'b1.[0] should strictly equal "bye!"');
  }
  ...
  function passTheAssertions2() {
    ...
    console.assert(value1 !== value2, "value1 should strictly equal to 5");
