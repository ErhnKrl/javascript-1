...
try {
  ...
  */
  ...
  const writeTestCases1 = [
    ...
    { name: 'second', args: [1, 4], expected: 5 },
    ...
    { name: 'fifth', args: [1, 1], expected: 2 }, // create your own test case!
    { name: 'sixth', args: [1, 3], expected: 4 }, // create your own test case!
  ];
  ...
  const writeTestCases2 = [
    ...
    { name: 'fifth', args: [6, 7], expected: -1 }, // create your own test case!
    { name: 'sixth', args: [6, 9], expected: -3 }, // create your own test case!
  ];
  ...
  const writeTestCases3 = [
    ...
    { name: 'second', args: [2.5, 2], expected: 5 },
    ...
    { name: 'fifth', args: [6, 7], expected: 42 }, // create your own test case!
    { name: 'sixth', args: [6, 9], expected: 54 }, // create your own test case!
  ];
  ...
  const writeTestCases5 = [
    ...
    { name: 'sixth', args: ['x','y','z'], expected: 'yzx' }, // create your own test case!
  ];
