...
try {
  ...
  function passTheAssertions1() {
    ...
    a1.x=a2.x="hi!"; // write one line to pass the assertions
    ...
    a1[index]=a2[index]="roof!"; // write one line to pass the assertions
  ...
  function passTheAssertions2() {
    ...
    console.assert(value1 !== null, "value1 should strictly equal to 5");
  ...
  function passTheAssertions3() {
    let obj1={x:'A', y:'B', z:'y'}; // write this line
    let obj2={x:'A', y:'B', z:'y'}; // write this line
